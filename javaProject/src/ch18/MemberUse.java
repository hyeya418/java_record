...
public class MemberUse {
	public static void main(String[] args) {
		...
		FileOutputStream fos = null;  //파일 저장을 위한 출력스트림
		ObjectOutputStream oos = null;//메모리에 있는 객체를 파일로 저장하기 위한 스트림
		MemberDTO m1 = new MemberDTO("kim", "김길동", "1234", 20, "kim@gmail.com");
		MemberDTO m2 = new MemberDTO("lee", "이길동", "1234", 25, "lee@gmail.com");
		MemberDTO m3 = new MemberDTO("park", "박길동", "1234", 30, "park@gmail.com");
		try {
