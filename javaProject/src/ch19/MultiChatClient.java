...
public class MultiChatClient {
	...
	public static void main(String[] args) {
		...
		Socket socket;
		try {
			String serverIp = "localhost";//원래는 실제 ip주소 값 필요
			//소켓을 생성하여 연결 요청
			socket = new Socket(serverIp, 7777);
			System.out.println("서버에 연결되었습니다.");
			Thread receiveThread = new ClientReciver(socket);
			receiveThread.start(); //start() => run()메서드 호출
